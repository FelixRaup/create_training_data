...
from utils import get_config_from_snapshot, pychem_data_generator, balance_by_histogram
from utils import get_random_config, transform, inverse_transform
...
training_folder = "data/data_hist_balanced_10D_nobalance" # "data_hist_balanced_10D_longtime"
input_size = 10
save_physical = True
plot = True
balance = False
...
if balance:
    X_scaled_balanced, y_scaled_balanced = balance_by_histogram(X_scaled, y_scaled, bins=50, target_count=10000, min_threshold=2000, dimensions=[0, 1, 2, 4])
else:
